...
OUTPUT_ARCH(riscv)
ENTRY(_start)
SEARCH_DIR("=/home/ilg/actions-runners/xpack-dev-tools/2/_work/riscv-none-elf-gcc-xpack/riscv-none-elf-gcc-xpack/build-assets/build/win32-x64/x86_64-pc-linux-gnu/install/riscv-none-elf/lib"); SEARCH_DIR("=/usr/local/lib"); SEARCH_DIR("=/lib"); SEARCH_DIR("=/usr/lib");
SECTIONS
{
