...
// #ifndef DRIVE_H
// #define DRIVE_H
// // Checks whether a specific keyboard key is currently being held down
...
// //Takes a return function with no argument as the parameter
// int8_t matrix_pressed(uint16_t (*matrix)(void)) {
//     uint16_t adc_value = matrix(); //execute function put in matrix_pressed
//     // Check every known button one by one.
//     for (uint8_t i = 0; i < NUM_BUTTONS; i++) {
//         if (buttons[i] == adc_value) {
//             return i;
//         }
//     }
//     return no_button_pressed; // If none matches
// }
...
// // 4 same functions below has been moved to this path file below
...
// // inline JOY_setseed_default(void) { rnval = 0x1234; }

// // inline JOY_setseed(uint16_t seed) { rnval = seed; }
